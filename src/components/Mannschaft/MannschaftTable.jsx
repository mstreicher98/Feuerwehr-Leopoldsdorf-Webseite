...
import { Avatar, Badge, Table, Group, Text, ActionIcon, Anchor, rem, UnstyledButton, TableThead, TableScrollContainer, TableTr, TableTbody, TableTh, TableTd, Center, Card } from '@mantine/core';
...
export async function MannschaftTable() {
    ...
    console.log(mannschaftRes.data.data);
    ...
    return (
        <Card h={500}>
        <TableScrollContainer minWidth={800} ta={"center"}>
